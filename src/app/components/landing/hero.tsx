'use client'
import { ArrowRight, AlertTriangle, DollarSign, Shield, Lock, Heart, BookOpen, Scale, Clock, TrendingUp } from 'lucide-react'
...
export function Hero() {
  return (
    <section id='home' className='relative min-h-screen overflow-hidden pt-16 bg-gradient-to-br from-red-950 via-black to-yellow-950'>
      {/* SECTION 1 - HERO */}
      <div className='container mx-auto px-4 py-20 md:py-32'>
        <div className='mx-auto max-w-7xl text-center'>
          ...
          >
            <Link to='/ly-luan'>
              <Button size='lg' className='group gap-2 text-lg px-8 py-6 bg-gradient-to-r from-red-700 to-yellow-700 hover:from-red-600 hover:to-yellow-600 border-yellow-600'>
            ...
            <Link to='/thuc-tien'>
              <Button size='lg' variant='outline' className='text-lg px-8 py-6 bg-transparent border-yellow-700 text-yellow-400 hover:bg-yellow-900/30'>
          ...
          <div className='max-w-5xl mx-auto'>
            ...
            >
              <div className='relative p-8 md:p-12 rounded-2xl border-2 border-yellow-600/50 bg-gradient-to-br from-red-950/60 to-black/80 backdrop-blur-sm'>
                ...
                <p className='text-right text-gray-400 relative z-10'>
            ...
            >
              <Link to='/ly-luan'>
                <Button size='lg' className='bg-gradient-to-r from-red-700 to-yellow-700 hover:from-red-600 hover:to-yellow-600'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
              {[
                ...
                { 
                  ...
                  example: 'VD: Xử lý 500+ quan chức cấp cao (2012-2024)',
                ...
                return (
                  <motion.div
                    ...
                    className='relative group'
                  >
                    <div className='absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-30 transition-opacity rounded-2xl blur-2xl'
                         style={{ background: `linear-gradient(to bottom right, var(--tw-gradient-stops))` }} />
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-7xl mx-auto'>
            ...
            <div className='grid md:grid-cols-2 gap-12 mb-16'>
              ...
              >
                {[
                  { number: '500+', label: 'Cán bộ cấp cao bị xử lý', subtext: '2012-2024' },
              ...
              >
                <h3 className='text-2xl font-bold text-yellow-100 mb-6 flex items-center gap-2'>
                  ...
                  Timeline: Các vụ án lớn
                </h3>
                <div className='space-y-4'>
                  {[
                    { year: '2020', case: 'Vụ Việt Á', detail: 'Gian lận thiết bị y tế' },
                    { year: '2021', case: 'Chuyến bay giải cứu', detail: 'Lợi dụng dịch COVID-19' },
                    { year: '2022', case: 'Vạn Thịnh Phát', detail: 'Chiếm đoạt tài sản nghìn tỷ' },
                    { year: '2023', case: 'Thuận An', detail: 'Sai phạm đất đai, tham nhũng' }
                  ].map((item, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      <div className='flex-shrink-0 w-16 h-16 rounded-full bg-gradient-to-br from-red-600 to-yellow-600 flex items-center justify-center font-bold text-white'>
                        {item.year}
                      </div>
                      <div>
